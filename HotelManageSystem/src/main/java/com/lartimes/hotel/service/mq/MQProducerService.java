...
public class MQProducerService  {
    ...
    // 建议正常规模项目统一用一个TOPIC
    private static final String topic = "HOTEL_APPOINTMENT_TOPIC";
    ...
    public SendResult sendMsg(String msgBody) {
        SendResult sendResult = rocketMQTemplate.syncSend(topic + ":tag2", MessageBuilder.withPayload(msgBody).build());
     ...
     */
    public void sendDelayMsg(String msgBody, int delayLevel , String tag) {
